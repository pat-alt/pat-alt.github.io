...
categories:
  ...
  - Julia
description: >-
  A guide demonstrating how to use [`ConformalPrediction.jl`](https://github.com/pat-alt/ConformalPrediction.jl) to conformalize a deep image classifier in a few lines of code.
image: www/intro.gif
jupyter: julia-1.8
draft: false
---
