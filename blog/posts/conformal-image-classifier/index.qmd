...
categories:
  ...
  - Julia
description: >-
  A how-to guide for Comformalized Image Classification in Julia lifted from the documentation of [`ConformalPrediction.jl`](https://github.com/pat-alt/ConformalPrediction.jl).
image: www/intro.gif
jupyter: julia-1.8
draft: false
---
...
<div class="intro-gif">
  <figure>
    ...
    <figcaption>Conformalised prediction sets for a<br>simple Deep Image Classifier.</figcaption>
  </figure>
</div>
...
function plot_results(mach, X, y; set_size=1, n_samples=3, kwargs...)
    ...
    for i in chosen
        ...
        title = "C={$title}\nytrue=$ytrue"
        plt = plot(x; axis=nothing, bottom_margin=10mm, kwargs...)
...
anim = @animate for i in repeat([1,2,3],n_total)
    plot_results(mach, X, y; set_size=i, n_samples=1)
end
gif(anim, joinpath(www_path, "intro.gif"), fps=1)

anim = @animate for i in repeat([1,2,3],n_total)
    plot_results(mach, X, y; set_size=i, n_samples=3)
end
