...
> With the template built and distributed, how do others and I actually use it?
...
where `tudelft-revealjs` is just the name of the custom format. 

The extension can be extended further locally by providing yet another [custom style sheet](https://github.com/pat-alt/pat-alt.github.io/blob/b6207a616f6ef9c7ec09cf8ad3383db788b9148b/content/talks/posts/2023-ieee-satml/custom.scss#L1), as I have done for my paper presentation:
...
Check out the final presentation [here](../../../content/talks/posts/2023-ieee-satml/presentation.qmd){target="_blank"}. 
