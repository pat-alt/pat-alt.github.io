...
I've said it before: [Quarto](https://quarto.org/) is amazing! Since the beginning of my PhD I haven't used any other tool for prototyping, writing and publishing any of my work.^[Not entirely true: I've also used `Pluto.jl` 🎈 and had to resort to `.Rmd` in one particular case.] That work has included: this website, presentations, academic articles, notebooks and more. By highlighting useful features of Quarto in articles like this one, I hope to encourage more people to try it out. 
