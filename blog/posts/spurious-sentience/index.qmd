...
regtable(
    ...
    renderSettings = RegressionTables.htmlOutput(joinpath(BLOG_DIR, "results/regression_full.html")),
    regression_statistics = reg_stats,
    labels = labels,
)
regtable(
    ols_all_latent, ols_best_latent, ols_ar, ols_factors, ols_best; 
    renderSettings = RegressionTables.latexOutput(joinpath(BLOG_DIR, "results/regression_full.tex")),
    regression_statistics = reg_stats,
    labels = labels,
)
regtable(
    ols_factors, ols_best; 
    renderSettings = RegressionTables.htmlOutput(joinpath(BLOG_DIR, "results/regression.html")),
    regression_statistics = reg_stats,
    labels = labels,
)
regtable(
    ols_factors, ols_best; 
    renderSettings = RegressionTables.latexOutput(joinpath(BLOG_DIR, "results/regression.tex")),
    regression_statistics = reg_stats,
    labels = labels,
)
```
