...
description: >-
  This is an opinionated post that questions the idea that the finding of patterns in latent embeddings of artificial neural networks is surprising. We back this claim using examples from Economics, a discipline that does not typically anthropomorphize the models it produces. This is also a companion blog post to our recent paper on the topic.
