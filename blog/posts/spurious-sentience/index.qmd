...
b = mod.model(a)
A = b.hidden_state
Serialization.serialize("$BLOG_DIR/output/encodings.jls", A)
```
...
query = [
    ...
    "The doves had interest in flying increased.",
    "The hawks had interest in flying decreased.",
    "Unemployment of postal doves is at an all-time low.",
    "Unemployment of postal doves is at an all-time high.",
