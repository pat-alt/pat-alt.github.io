...
date: "2021-02-07"
summary: 'Research on explainable AI has recently gained considerable momentum. In this post I explore a Bayesian approach to ex-post explainability of Deep Neural Networks.'
output:
  blogdown::html_page:
      toc: true
...
tags: [deeplearning, interpretableai, neuralnets, bayes]
---
...
Having established this basic, flexible set-up the @ish2019interpreting go on to derive closed-form expressions for RATE in this setting. The details are omitted here since the logic is largely analogous to what we learned above, but can be found in @ish2019interpreting.
