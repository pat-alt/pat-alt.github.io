...
1. Three presentations at JuliaCon 2022:
    - [Explaining Black-Box Models through Counterfactuals](https://pretalx.com/juliacon-2022/talk/HU8FVH/)^[The relevant Julia package repository can be found here: [https://github.com/pat-alt/CounterfactualExplanations.jl](https://github.com/pat-alt/CounterfactualExplanations.jl). The repository that will be used to generate the relevant [JuliaCon Proceedings](https://proceedings.juliacon.org/) paper can be found here: [https://github.com/pat-alt/CounterfactualExplanations.jl/tree/paper](https://github.com/pat-alt/CounterfactualExplanations.jl/tree/paper).]
    - [Effortless Bayesian Deep Learning through Laplace Redux](https://pretalx.com/juliacon-2022/talk/Z7MXFS/)^[The relevant Julia package repository can be found here: [https://github.com/pat-alt/LaplaceRedux.jl](https://github.com/pat-alt/LaplaceRedux.jl).]
...
![A sad 🐱 on its counterfactual path to its cool dog friends.](https://raw.githubusercontent.com/pat-alt/CounterfactualExplanations.jl/main/docs/src//www/images/recourse_laplace.gif)
...
:::{.column width="50%"}
![Simulation of changing posteriour predictive distribution. Image by author.](https://raw.githubusercontent.com/pat-alt/LaplaceRedux.jl/main/dev/resources/juliacon22//www/images/intro.gif){width="70%"}
:::
...
- `CounterfactualExplanations.jl` package [docs](https://www.paltmeyer.com/CounterfactualExplanations.jl/dev/) with lots of examples.
