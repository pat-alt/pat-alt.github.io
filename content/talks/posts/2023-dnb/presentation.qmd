...
2. Retrieve relevant information from large collection of text
3. Long document understanding and track/identify/predict anomaly patterns

## Privacy Enhancing Technologies (PET)

1. Synthetic data generation by ML, algorithmic, probabilistic and statistical techniques.
...
## Human-AI Collaboration: Augmenting human experts with AI

1. Hybrid human-AI workflows: amplify human intelligence, reduce human cost, and improve precaution 
2. Collaborative human-AI knowledge synthesis
3. Explainable AI, and Human-in-the-loop continual learning

## Automated Compliance

1. Ensure decisions made by banks' models are compliant by being explainable and robust: 
  - Counterfactual reasoning and contestability 
