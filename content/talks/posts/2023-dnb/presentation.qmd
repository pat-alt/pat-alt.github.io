...
- Part of [AI for FinTech Research Lab](https://se.ewi.tudelft.nl/ai4fintech/index.html)---5yr collaboration between TU Delft and ING.
...
- [Blogger](https://www.patalt.org/blog/), Julia [developer](https://github.com/pat-alt) and founder of [Taija](https://github.com/JuliaTrustworthyAI).
...
::: {.notes}
- To give you a better idea of my research profile, I've listed some of my publications below.
...
:::{.notes}
- In this context, this is usually about ... 
...
5. Predictive Uncertainty Quantification for LLMs (see [blog](https://www.patalt.org/blog/posts/conformal-llm/) post). 
...
- A term you may have heard a lot recently is 'human alignment': we want to ensure that AI systems are aligned with human values.
...
- We want to ensure, for example, that ...
:::
