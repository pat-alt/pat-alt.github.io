...
## Hypothetical Example: Insurance Premium

For simplicity, we'll stay in the classification setting^[Work on counterfactual regression like @spooner2021counterfactual exists but it is scarce.]:
...
> All individuals have a right to an explanation for the model's decision. Those providing more sensitive data can be expected to place higher demands on the quality of the explanation.
