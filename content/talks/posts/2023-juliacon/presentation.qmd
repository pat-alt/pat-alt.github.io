...
POST_DIR = "content/talks/posts/2023-juliacon"
using Pkg; Pkg.activate(POST_DIR)
```
...
![QR code redirects to notebook hosted on [binder](https://mybinder.org/): [https://tinyurl.com/cpjcon23](https://tinyurl.com/cpjcon23)](www/qr_pluto.svg){width=45%}
:::
::::
...
> We had a great talk on [`SymbolicRegression.jl`](https://github.com/MilesCranmer/SymbolicRegression.jl) this week, so I thought I'd take it for ride
