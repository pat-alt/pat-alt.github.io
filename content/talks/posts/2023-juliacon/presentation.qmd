...
1. 🏃 Interactive sprint of [`ConformalPrediction.jl`](https://github.com/JuliaTrustworthyAI/ConformalPrediction.jl) using [`Pluto.jl`](https://github.com/fonsp/Pluto.jl) 🎈 (15min)
2. 🔍 Applications (5min)
   - Conformal Chatbot
