...
<!-- TODO: possibly add slide on mitigation here -->
...
<!-- TODO: Add slide with density charts and link to blog post -->
...
![Illustration of how CT improves model explainability: (a) conventional training, all mutable; (b) CT, all mutable; (c) conventional, *age* immutable; (d) CT, *age* immutable.](www/ct_poc.png)
...
::::{.columns}::::
:::{.column width='50%'}
📜 In @altmeyer2024position \@ ICML 2024, we challenge the idea that the finding of meaningful patterns in latent spaces of large models is indicative of AGI.
:::
:::{.column width='50%'}
