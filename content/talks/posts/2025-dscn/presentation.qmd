...
![Counterfactual explanation for what it takes to be a dog.](www/cat.gif){width="60%"}
:::

::: {.content-visible when-format="pdf"}
![Counterfactual explanation for what it takes to be a dog.](www/cat.png){width="60%"}
:::

## Methodology {auto-animate=true}
...
::: {.content-visible when-format="html"}
![Gradient-based counterfactual search.](www/ce_intro.gif){#fig-ce-intro width="85%"}
:::

::: {.content-visible when-format="pdf"}
![Gradient-based counterfactual search.](www/ce_intro.png){#fig-ce-intro width="85%"}
:::
