...
#show: doc => poster(
  ...
  // TLDR image:
  $if(tldr-image)$ tldr_image: "$tldr-image$", $endif$
  $if(tldr-image-vspace)$ tldr_image_vspace: "$tldr-image-vspace$", $endif$

  // TLDR text:
  $if(tldr)$ tldr: [$tldr$], $endif$
  $if(tldr-font-size)$ tldr_font_size: "$tldr-font-size$", $endif$
